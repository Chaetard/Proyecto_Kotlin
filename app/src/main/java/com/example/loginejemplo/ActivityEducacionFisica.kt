...
import com.example.loginejemplo.databinding.ActivityEducacionFisicaBinding

class ActivityEducacionFisica : AppCompatActivity() {

    private lateinit var binding: ActivityEducacionFisicaBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityEducacionFisicaBinding.inflate(layoutInflater)
