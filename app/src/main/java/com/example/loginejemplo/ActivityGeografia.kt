...
import com.example.loginejemplo.databinding.ActivityGeografiaBinding

class ActivityGeografia : AppCompatActivity() {

    private lateinit var binding: ActivityGeografiaBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityGeografiaBinding.inflate(layoutInflater)
