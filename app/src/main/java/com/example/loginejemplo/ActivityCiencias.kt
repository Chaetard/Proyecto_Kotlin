...
import com.example.loginejemplo.databinding.ActivityCienciasBinding

class ActivityCiencias : AppCompatActivity() {

    private lateinit var binding: ActivityCienciasBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityCienciasBinding.inflate(layoutInflater)
