...
import com.example.loginejemplo.databinding.ActivityEticaBinding

class ActivityEtica : AppCompatActivity() {

    private lateinit var binding: ActivityEticaBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityEticaBinding.inflate(layoutInflater)
