...
import com.example.loginejemplo.databinding.ActivityTutoriasBinding

class ActivityTutorias : AppCompatActivity() {

    private lateinit var binding: ActivityTutoriasBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityTutoriasBinding.inflate(layoutInflater)
        ...
        binding.recyclerViewTutorias.layoutManager = LinearLayoutManager(this)
        binding.recyclerViewTutorias.adapter = adapter
