...
import com.example.loginejemplo.databinding.ActivityMatematicasBinding

class ActivityMatematicas : AppCompatActivity() {

    private lateinit var binding: ActivityMatematicasBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityMatematicasBinding.inflate(layoutInflater)
        ...
        val blocks = listOf(
            ...
            Block(R.drawable.paperairplane, "Tarea 7 Fisica", "PROMEDIO: 100"),
